import codecs
with codecs.open('src/system/wifi_debug_server.cpp', 'r', 'utf-8', errors='ignore') as f: text = f.read()

start_sig = 'String WiFiDebugServer::buildDebugPage() const {'
end_sig = 'String WiFiDebugServer::buildStatusJson() const {'

new_html = r'''String WiFiDebugServer::buildDebugPage() const {
  String html = R"RAW(
<!DOCTYPE html>
<html lang="zh-CN">
<head>
